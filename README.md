...
Project page for prompt-driven multi-part SDF decomposition on a frozen TripoSG shape VAE.

- `index.html` — architecture + the overfitting experiment (13 assets, 1 prompt point per part)
